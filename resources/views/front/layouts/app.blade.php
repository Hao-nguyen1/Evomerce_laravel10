...
<body data-instant-intensity="mousedown">
            ...
            <nav class="navbar navbar-expand-xl" id="navbar">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-uppercase"
                                href="{{ route('front.aboutUs') }}">{{ __('ABOUT-US') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-uppercase"
                                href="{{ route('front.contactUs') }}">{{ __('CONTACT-US') }}</a>
                        </li>
                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-card">
                        ...
                        <ul>
                            <li><a href="{{ route('front.aboutUs') }}">{{ __('Introduce') }}</a></li>
    ...
    <df-messenger intent="WELCOME" chat-title="CHAT_BOT_AI" agent-id="f9a746e4-b899-40b4-8723-c87e49437be7"
